...
const BITG_ENVIRONMENT = process.env['BITG_ENVIRONMENT'] || 'local'; // eslint-disable-line dot-notation
...
export default function setupSentry() {
	const environment = __DEV__ || !BITG_ENVIRONMENT ? 'development' : BITG_ENVIRONMENT;
