...
const BITG_ENVIRONMNET = process.env['BITG_ENVIRONMNET'] || 'local'; // eslint-disable-line dot-notation
...
export default function setupSentry() {
	const environment = __DEV__ || !BITG_ENVIRONMNET ? 'development' : BITG_ENVIRONMNET;
