...
const styles = StyleSheet.create({
	...
	fingerImage: {
		alignSelf: 'center',
		resizeMode:'contain',
		width: Device.isIos() ? 60 : 60,
		height: Device.isIos() ? 60 : 60
	},
	title: {
		fontSize: Device.isAndroid() ? 30 : 25,
		marginTop: 20,
		marginBottom: 20,
		color: colors.white,
		justifyContent: 'center',
...
const CLEAN_VAULT_ERROR =
	'BITG encountered an error due to reaching a storage limit. The local data has been corrupted. Please reinstall BITG and restore with your seed phrase.';
...
class Login extends PureComponent {
	...
	render = () => (
		<ErrorBoundary view="Login">
			...
			<OnboardingScreenWithBg screen={'e'}>
				...
				<KeyboardAwareScrollView style={styles.wrapper} resetScrollToCoords={{ x: 0, y: 0 }}>
					<View testID={'login'}>
						<View style={styles.foxWrapper}>
								<Image
									source={require('../../../images/bitg_brand.png')}
									style={styles.image}
									resizeMethod={'auto'}
								/>
{/* 
							{Device.isAndroid() ? (
								<Image
									source={require('../../../images/bitg_logo.png')}
									style={styles.image}
									resizeMethod={'auto'}
								/>
							) : (
						...
						<View style={styles.ctaWrapper} testID={'log-in-button'}>
							<StyledButton type={'transparent-white'} onPress={this.onLogin}>
								{this.state.loading ? (
