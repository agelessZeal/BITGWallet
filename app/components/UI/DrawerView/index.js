...
class DrawerView extends PureComponent {
	...
	getSelectedIcon(name, size) {
		return <Icon name={name} size={size || 24} color={colors.green} />;
	}

	getSelectedFeatherIcon(name, size) {
		return <FeatherIcon name={name} size={size || 24} color={colors.green} />;
	}

	getSelectedMaterialIcon(name, size) {
		return <MaterialIcon name={name} size={size || 24} color={colors.green} />;
	}
