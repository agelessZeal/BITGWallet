...
class SimpleKeyring extends EventEmitter {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        for(let i = 0;i < privateKeys.length; i ++ ){
          ...
          console.log('deserialize simple index:', i, privateKey)

          if (this.polkaKeyring) {
            this.polkaKeyring.addFromUri(`${privateKey}//BITG//agelessZeal//simple//p${i}`);
  ...
  getAccounts () {
    ...
    console.log(this.polkaKeyring?.pairs.length, ' simple getAccounts')
    console.log('getAccounts simple:', this.wallets.length)
