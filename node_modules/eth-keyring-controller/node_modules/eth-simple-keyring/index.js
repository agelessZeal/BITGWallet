...
class SimpleKeyring extends EventEmitter {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.wallets = privateKeys.map((privateKey) => {
          console.log('simple keyring deserialize:',privateKey)
          const stripped = ethUtil.stripHexPrefix(privateKey)
          const buffer = Buffer.from(stripped, 'hex')
          const wallet = Wallet.fromPrivateKey(buffer)

          if(this.polkaKeyring){
            console.log('pokaKeyring simple  key add new address:')
            this.polkaKeyring.addFromUri(`${privateKey}//BITG/agelessZeal`)
            // console.log(this.polkaKeyring.addFromUri(`${randomMini}//hard`).address);
          }
  ...
  getAccounts () {
    console.log('simple kerying getAccounts:', this.wallets)
