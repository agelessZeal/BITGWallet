...
class KeyringController extends EventEmitter {
  ...
  getPolkaPair (_fromAddress, opts = {}) {
    
    // const fromAddress = normalizeAddress(_fromAddress)

    // console.log('eth keyring controller ',_fromAddress,":",fromAddress)

    return this.getKeyringForAccount(_fromAddress)
      .then((keyring) => {
        return keyring.getPolkaPairFor(_fromAddress, opts)
      })
  }
  ...
  createFirstKeyTree () {
    this.clearKeyrings()
    console.log('createFirstKeyTree')
  ...
  getKeyringForAccount (address) {
    const hexed = address ; ///normalizeAddress(address)
