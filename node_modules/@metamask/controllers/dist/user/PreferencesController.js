...
class PreferencesController extends BaseController_1.default {
    ...
    addIdentities(addresses) {
        ...
        console.log('PreferencesController addIdentities:',addresses)
    ...
    removeIdentity(address) {
        // address = util_1.toChecksumHexAddress(address);
        console.log('PreferencesController removeIdentity:',address)
        const { identities } = this.state;
        if (!identities[address]) {
            return;
        }
    ...
    syncIdentities(addresses) {
        console.log('Preference syncIdentities:',addresses)
    ...
    updateIdentities(addresses) {
        ...
        console.log('PreferencesController updateIdentities:',addresses)
    ...
    setSelectedAddress(selectedAddress) {
        console.log('PreferencesController selectedAddress:',selectedAddress)
