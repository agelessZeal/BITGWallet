...
] extends [never] ? T extends primitive ? T : T extends (infer U)[] ? IsJsonable<U>[] : T extends object ? {
 ...
 */
export declare type StateDeriver<T> = (value: IsJsonable<T>) => IsJsonable<Json>;
/**
 * State metadata.
 *
...
declare type StateChangeEvent<N extends string, S, E> = E extends {
    type: `${N}:stateChange`;
    payload: [S, Patch[]];
} ? E : never;
/**
 ...
 */
export declare class BaseController<N extends string, S extends Record<string, unknown>> {
     ...
     */
    protected update(callback: (state: Draft<IsJsonable<S>>) => void | IsJsonable<S>): void;
    /**
 ...
 */
export declare function getAnonymizedState<S extends Record<string, unknown>>(state: IsJsonable<S>, metadata: StateMetadata<S>): IsJsonable<Record<string, Json>>;
/**
 ...
 */
export declare function getPersistentState<S extends Record<string, unknown>>(state: IsJsonable<S>, metadata: StateMetadata<S>): IsJsonable<Record<string, Json>>;
export {};
