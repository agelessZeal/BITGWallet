...
class KeyringController extends BaseController_1.default {
    ...
    constructor({ removeIdentity, syncIdentities, updateIdentities, setSelectedAddress, }, config, state) {
        ...
        console.log('KeyringController constructor state:',state)
    }
    /**
    ...
    addNewAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log('KeyringController addNewAccount')
            ...
            console.log('KeyringController addNewAccount',oldAccounts,newAccounts)
    ...
    createNewVaultAndRestore(password, seed) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log('createNewVaultAndRestore:',password,seed,vault)
    ...
    createNewVaultAndKeychain(password) {
        console.log('KeryingController createNewVaultAndKeychain:',password)
        return __awaiter(this, void 0, void 0, function* () {
            const releaseLock = yield this.mutex.acquire();
            try {
                const vault = yield privates
                ...
                console.log('KeryingController vault:',vault)
                console.log('privates.get(this).keyring.keyrings[0].mnemonic;',privates.get(this).keyring.keyrings[0].mnemonic)
                this.updateIdentities(yield privates.get(this).keyring.getAccounts());
                this.fullUpdate();
                return vault;
            }
    ...
    exportSeedPhrase(password) {
        ...
        console.log('exportSeedPhrase:',password,' :keyring pass:',privates.get(this).keyring.password)
        if (privates.get(this).keyring.password === password) {
            console.log('exportSeedPhrase  in KeyringController: seed :',privates.get(this).keyring.keyrings[0].mnemonic,": pass:",password)
    ...
    exportAccount(password, address) {
        console.log('exportAccount:',password)
        if (privates.get(this).keyring.password === password) {
            console.log('exportAccount:',privates.get(this).keyring.exportAccount(address))
     ...
     */
    getAccounts() {
        console.log('privates.get(this).keyring.getAccounts():',privates.get(this).keyring.getAccounts())
    ...
    submitPassword(password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // console.log('privates.get(this).keyring.',privates.get(this).keyring)
            const accounts = yield privates.get(this).keyring.getAccounts();
            console.log('KeryingController submit password:',password,accounts)
